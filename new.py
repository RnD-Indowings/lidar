...
# MAVROS parameters
threshold_distance = 2.0  # Obstacle detection threshold (meters)
altitude_increment = 15.0  # Increase altitude by 15m per avoidance step
current_mode = None
previous_mode = None
...
def increase_altitude_offboard():
    ...
    new_altitude = base_altitude + altitude_increment  # Target altitude
    pose = PoseStamped()
